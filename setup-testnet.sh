...
# Daddy-config Testnet Setup Script
...
echo -e "${BLUE}🚀 Daddy-config Testnet Setup Script${NC}"
echo "=================================="
echo ""
...
echo "Step 4: Building and deploying Daddy-config contract..."

# Check if we're in the right directory
if [ ! -f "Cargo.toml" ]; then
    print_error "Cargo.toml not found. Please run this script from the Daddy-config root directory."
    exit 1
fi
...
if [ ! -f "target/wasm32-unknown-unknown/release/daddy-config.wasm" ]; then
...
# Deploy contract
print_info "Deploying Daddy-config contract..."
...
# Contract IDs
DADDY-CONFIG_CONTRACT_ID=$CONTRACT_ID
...
echo "=================================="
echo ""
echo "Your Daddy-config testnet environment is ready:"
echo ""
echo -e "${BLUE}Contract Information:${NC}"
echo "  Daddy-config Contract: $CONTRACT_ID"
